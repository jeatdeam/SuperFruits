...
export const DeleteGroup = ({id, refetch, activePosition}:{id:string, refetch: () => void, activePosition: boolean}) => {
    ...
    return (
        <svg onClick={removeGroup} className={` ${activePosition ? "absolute bg-white" : ""} top-[5px] right-[5px] transition-half  size-[30px] rounded-full`} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#999999">
