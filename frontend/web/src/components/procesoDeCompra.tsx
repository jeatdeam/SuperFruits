...
export const ProcesoDeCompra = () => {
    ...
    return(
        <section className="containerProcess w-[80%] xl:w-[1280px] h-[100px] flex items-center px-[5%] mx-auto">
            <div className={"relative processOne flex-1 bg-white h-[5px]"}>

                <div className={"absolute flex flex-col translate-y-[-50%] z-10"}>
                    <div
                        className={"size-[25px] bg-blue-300 rounded-full flex items-center justify-center text-[12.5px] z-[2]"}>1
                    </div>
                    <div
                        className={"shadow-[0_0_0_2.5px_rgba(173,216,230,1)]  whitespace-pre-line absolute left-1/2 translate-x-[-50%] bg-blue-300/50 rounded-full top-[125%] flex items-center justify-center text-[12.5px] z-[2]"}>{count ?
                        <Check/> : <ShoppingCar/>}</div>
                </div>
            ...
            <div className={"relative processTwo flex-1 bg-white h-[5px]"}>
                <div
                    className={"size-[25px] bg-blue-300 absolute left-[-5px] top-1/2 -translate-y-1/2 rounded-full flex items-center justify-center text-[12.5px] z-[2]"}>2
                </div>
            ...
            <div className={"relative processThree flex-1 bg-white h-[5px]"}>
                <div
                    className={"size-[25px] bg-blue-300 absolute left-[-5px] top-1/2 -translate-y-1/2 rounded-full flex items-center justify-center text-[12.5px] z-[2]"}>3
                </div>
