...
export const DeleteGroup = ({id, refetch, activePosition}:{id:string, refetch: () => void, activePosition: boolean}) => {
    ...
    const removeGroup = () => {
        ...
        const url = "http://localhost:4000/deleteGroup";
    ...
    return (
        <svg onClick={removeGroup} className={` ${activePosition ? "absolute" : ""} top-[5px] right-[5px] transition-half hover:bg-white size-[25px] rounded-full`} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#999999">
